...
async function getSeoData() {
    try {
        const res = await fetch(`https://pinkspot.cc/api/v1/pages/getPageById/653251a1efe8c2f29fdce87d`);
...
export async function generateMetadata() {
    ...
    const title = seo?.seotitle || "Privacy Policy | PinkSpot";
    const description =
        seo?.seodescription ||
        "Read PinkSpot's privacy policy to understand how we protect your data.";
